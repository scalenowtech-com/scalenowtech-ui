    ...
    return (
        ...
        <section className="section hero has-bg-image" aria-label="home">
            <div className="container">
                ...
                <h1 className="h1 hero-title">We strive to provide innovative and reliable software development</h1>
                ...
                <p className="hero-text">
                    Recognised by : <a href="index.html"><img src="https://globemoving.net/blog/wp-content/uploads/2016/04/start-up.png" className="img-fluid" alt="logo"/></a>
                </p>
