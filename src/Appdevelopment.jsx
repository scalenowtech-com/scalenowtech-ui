  ...
  return (
    <>
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <p className="hero-text">
                ...
                providing full-cycle mobile app development solutions that
                benefit a huge number of people & give a good return on
                investment.
              </p>
      ...
      <section
        ...
        aria-label="home"
      >
        <h1 className="h1 hero-title2">Our App Services</h1>
        <p className="hero-text2">
          At Scalenow, we specialize in turning your innovative ideas into fully
          functional and visually stunning mobile applications. Our app
          development services are designed to provide a soothing user
          ...
          <div className="row">
            <div className="col-md-4  ">
              <div class="content-box content-box-small">
                ...
                <p>
                  A large percentage of all mobile devices worldwide run on
                  Android. Therefore, good Android app development can help you
                  reach out to more customers, improve your brand image, create
                  a loyal customer base, and improve sales. From concept to
                  deployment, we ensure that your app stands out.{" "}
                </p>
              </div>
            </div>
            <div className="col-md-4 ">
              <div class="content-box content-box-small">
                ...
                <h5 className="iconbox-heading">App Technology Consulting</h5>
                <p>
                  Our highly skilled professional consulting team offers
                  technical knowledge to select the finest technology stack and
                  create a better mobile app.
                </p>
              </div>
            </div>
            <div className="col-md-4 ">
              <div class="content-box content-box-small">
                ...
                <h5 className="iconbox-heading">Native App Development</h5>
                <p>
          ...
          <div className="row">
            <div className="col-md-4 ">
              <div class="content-box content-box-small">
                ...
                <h5 className="iconbox-heading">Hybrid App Development</h5>
                <p>
                  At Scalenow, our highly dedicated app developers offer
                  best-in-class cross-platform mobile app development that runs
                  smoothly on all platforms like iOS and Android. Our app
                  development services focus on building strong and scalable
                  architectures. We ensure that your app can handle high user
                  loads, data storage, and future updates.
                </p>
              </div>
            </div>
            <div className="col-md-4 ">
              <div class="content-box content-box-small">
                ...
                <p>
                  We specialize in delivering custom iOS software to both
                  first-time entrepreneurs and enterprises across all sectors,
                  all over the globe. Our team of experts will develop your app
                  and ensure that it not only aligns but goes beyond Apple
                  users’ expectations.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4 ">
              <div class="content-box content-box-small">
                ...
                <p>
                  We will help you design and develop, test, and launch
                  full-fledged Flutter apps. We will also find the best
                  product-market fit to deploy your application across several
                  platforms seamlessly. Our team of Flutter Android app
                  development and deployment experts can also take your existing
                  Android or iOS application across platforms and operating
                  systems.{" "}
                </p>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-md-4 ">
              <div class="service-box sb2">
                ...
                <hr />
                <p>
                  We understand that each app has unique requirements. Our
                  experienced team works closely with you to understand your
                  vision and develop tailored solutions that align with your
                  business goals.
                </p>
              </div>
            </div>
            <div className="col-md-4 ">
              <div class="service-box sb2">
                ...
                <hr />
                <p>
                  with the latest technologies and frameworks to create
                  high-performance and feature-rich apps. Whether it's native
                  app development or cross-platform solutions, we leverage the
                  best tools and technologies to deliver an app that exceeds
                  your expectations.
                </p>
              </div>
            </div>
            <div className="col-md-4 ">
              <div class="service-box sb2">
                ...
                <hr />
                <p>
                  User experience is at the heart of our app development
                  process. We create intuitive and user-friendly interfaces that
                  engage and delight your app users.{" "}
                </p>
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col-md-6 ">
              <div class="service-box sb2">
                ...
                <p>
                  {" "}
                  We have a dedicated quality assurance team that rigorously
                  tests your app across different devices, operating systems,
                  and usage scenarios. We ensure that your app performs
                  flawlessly, is bug-free, and delivers an exceptional user
                  experience.
                </p>
              </div>
            </div>
            <div className="col-md-6 ">
              <div class="service-box sb2">
                ...
                <p>
                  {" "}
                  Our relationship with you doesn't end with app deployment. We
                  provide comprehensive support and maintenance services to
                  ensure that your app stays up-to-date, secure, and optimized.
                  We monitor performance, fix issues, and incorporate new
                  features to keep your app at its best.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <ul className="tech_stack_ul">
                <li>
                  <BsFillCheckCircleFill /> Android
                </li>

                <li>
                  <BsFillCheckCircleFill /> React Native
                </li>

                <li>
                  <BsFillCheckCircleFill /> iOS
                </li>

                <li>
                  <BsFillCheckCircleFill /> Flutter
                </li>

                <li>
                  <BsFillCheckCircleFill /> SwiftUI
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="different-industry android-industries">
        <div className="container custom-container">
          <div className="row">
            <ul class="industry-list align-items-center justify-content-center">
              <li class="industry">
        ...
        <div className="container">
          <div className="row">
            ...
            <p className="last_note">
              ...
              Choose Scalenow for professional app development services that
              bring your vision to life.Contact us today to discuss your project
              and embark on an exciting journey to success.
            </p>
          </div>
        </div>
      </section>
